...
from podcast_studio.config import DEFAULT_PACE, SPEECH_PACES, TTS_MODEL
from podcast_studio.script_generator import DialogueLine, Script
...
def render_script_with_voices(
    ...
    from podcast_studio.tts_settings import get_provider, get_elevenlabs_config, PROVIDER_ELEVENLABS
    if get_provider() == PROVIDER_ELEVENLABS:
        from podcast_studio.elevenlabs_tts import render_single_voice as el_single, render_multi_speaker as el_multi
