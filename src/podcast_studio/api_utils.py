...
# Quota CỨNG (hết hạn mức ngày / free-tier limit 0) — retry vô ích, fail ngay.
_HARD_QUOTA_MARKERS = (
    "limit: 0",
    "PerDay",
    "FreeTier",
...
def is_hard_quota_error(e: BaseException) -> bool:
    """True nếu là lỗi hết quota cứng (cần bật billing / sang ngày mới), không phải rate-limit tạm thời."""
    msg = str(e)
    if "RESOURCE_EXHAUSTED" not in msg and "429" not in msg:
        return False
    return any(marker in msg for marker in _HARD_QUOTA_MARKERS)
