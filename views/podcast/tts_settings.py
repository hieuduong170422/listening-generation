...
from podcast_studio.elevenlabs_tts import voice_supports_model
...
def _fetch_voices():
    from podcast_studio.elevenlabs_tts import list_voices
    return list_voices()
...
if st.button("🎧 Gen thử", use_container_width=True):
    ...
    if not target_voice:
        ...
        from podcast_studio.elevenlabs_tts import synthesize_preview, ElevenLabsError, _bytes_to_segment
        import io as _io
        try:
